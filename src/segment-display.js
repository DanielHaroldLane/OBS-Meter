...
SegmentDisplay.prototype.draw = function () {
  ...
  if (display) {
    ...
    if (context) {
      ...
      var offsetX =
        (display.width - (width + skew * this.digitHeight) * scale) / 2.0
  ...
  switch (mask) {
    case '#':
      ...
      if (this.segmentCount == 16) {
        ...
        context.beginPath()
        context.moveTo(
          x + this.digitWidth - this.segmentWidth - d,
          y + this.segmentWidth
        )
        context.lineTo(x + t + d + s, y + this.segmentWidth)
        context.lineTo(x + t + d, y + s)
      ...
      if (this.segmentCount != 7) {
        ...
        if (this.segmentCount == 14) {
          ...
          context.lineTo(
            x + this.segmentWidth,
            y + this.segmentWidth + this.segmentDistance
          )
        } else {
          context.moveTo(x, y + this.segmentWidth + d)
          context.lineTo(x + s, y + s + d)
        ...
        context.lineTo(
          x + w - this.segmentDistance,
          y + h - this.segmentDistance - r
        )
        context.lineTo(
          x + w - this.segmentDistance,
          y + h - this.segmentDistance
        )
        context.lineTo(
          x + w - this.segmentDistance - r,
          y + h - this.segmentDistance
        )
        ...
        context.lineTo(
          x + w - this.segmentDistance,
          y + this.segmentDistance + r
        )
        context.lineTo(
          x + this.segmentDistance + r,
          y + h - this.segmentDistance
        )
        context.lineTo(x + this.segmentDistance, y + h - this.segmentDistance)
        context.lineTo(
          x + this.segmentDistance,
          y + h - this.segmentDistance - r
        )
        context.lineTo(
          x + w - this.segmentDistance - r,
          y + this.segmentDistance
        )
        context.fill()
...
SegmentDisplay.prototype.getSegmentColor = function (
  c,
  charSet7,
  charSet14,
  charSet16
